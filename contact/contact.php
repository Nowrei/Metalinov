          ...
          <form id="add-user-form" class="p-2" novalidate>
            <div class="row mb-3 gx-3">
              ...
              <div class="mb-3 w-50 p-3 mx-auto my-auto">
                <input type="text" name="entreprise" id="entreprise" class="form-control form-control-lg" placeholder="Nom d'Entreprise" required>
              ...
              <div class="mb-3 w-50 p-3 mx-auto my-auto">
                  <select class="form-select" aria-label="Default select example" name="pays">
                    <option selected>-Choissiez un pays-</option>
              ...
              <div class="mb-3 w-25">
                <input type="submit" value="Envoyer" class="btn btn-primary btn-block btn-lg" id="add-user-btn">
              </div>
