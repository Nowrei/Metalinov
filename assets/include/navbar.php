    ...
    <nav class="navbar navbar-dark bg-secondary text-light">
      <div class="container justify-content-between">
        <div class="d-none d-lg-block">
          <a href="index.php" class="navbar-brand"><img src="assets/img/image-site/logo-removebg-preview.png" alt=""  height="30"></a>
        </div>
...
<a class="nav-link dropdown-toggle text-light" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
          ...
          <ul class="dropdown-menu" aria-labelledby="navbarDarkDropdownMenuLink">
            ...
            <li><a class="dropdown-item" href="contact/connection.php" >Connection</a></li>
              ...
              <li class="nav-item">
                <a class="nav-link text-light" href="https://www.agristandard2000.fr/" target="_blank" rel="#">Site Agristandard 2000</a>
              </li>
            </ul>
          </div>
        </div>
