        ...
        <div class="row">
            <div class="card text-white mt-5 mb-3 mx-auto col-10 col-md-0 c-l bg-secondary" style="max-width: 20rem;">
                <div class="card-body" style="text-align: center;">
                    <h5 class="card-title mt-2">La charpente
                                                avec la boulonnerie
                                                et les crosses d’ancrage</h5>
                </div>
            </div>
            <div class="card text-white mt-5 mb-3 mx-auto col-10 col-md-0 c-l bg-secondary" style="max-width: 20rem;">
                <div class="card-body" style="text-align: center;">
                    <h5 class="card-title mt-2 ">La toiture en tôles nervurées ou en fibrociment avec les faîtières et toute la visserie</h5>
                </div>
            </div>
        </div>
    </div>
      ...
      <div class="d-flex flex-wrap-reverse">
          ...
          <div class="col align-self-center">
            <div class="mx-auto  w-75">
              ...
              <h2 class="text-center"> Champs d'application </h2><br>
              <p>
                
                Nos bâtiments sont conformes aux nouveaux règlements de neige et de vent.
                <hr>
                Dans tous les cas consultez-nous pour optimiser votre choix en fonction du lieu de construction.
                <hr>
              </p>
            </div>
          </div>
      ...
      <div class="d-flex flex-wrap-reverse">
          ...
          <div class="col align-self-center">
            <div class="mx-auto  w-75">
              ...
              <h2 class="text-center"> Ancrages au sol</h2><br>
              <p>
              Système articulé ou encastré
                <hr>
              </p>
            </div>
          </div>
      ...
      <div class="d-flex flex-wrap-reverse">
          ...
          <div class="col align-self-center">
            <div class="mx-auto  w-75">
              ...
              <h2 class="text-center"> Boulonnerie </h2><br>
              <p>
              Classe 8.8 (serrage normal) et boulons HR (haute résistance) classe 10. 9.
                <hr>
              </p>
            </div>
          </div>
