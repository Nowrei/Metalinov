...
<div class="w-100 p-3">
        ...
        <h3 class="text-dark-50 me-5 ms-5 mt-4">
            Modèles de bâtiments standards couverture tôle - Monopente + auvent fibro
        </h3>
    </div>
    ...
    <div id="image-gallery">
      <div class="row">
        ...
        <div class="card-body" style="text-align: center;">
                    <h4 class="card-title mt-2 text-center text-secondary">Monopente de largeur 8.25m + auvent de largeur 4m</h4>
                </div>
          <div class="img-wrapper">
            <a href="../../assets/img/tole-fibro/zoom_mfa08.gif"><img src="../../assets/img/tole-fibro/zoom_mfa08.gif" class="img-responsive"></a>
        ...
        <div class="col-lg-5 col-md-6 col-sm-6 col-xs-12 mx-auto image">
        <div class="card-body" style="text-align: center;">
                    <h4 class="card-title mt-2 text-center text-secondary">Monopente de largeur 11.04m + auvent de largeur 4m</h4>
                </div>
          <div class="img-wrapper">
