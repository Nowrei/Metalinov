...
<div class="m-information col-10 mb-5 mx-auto">
        <div class="row">
            <div class="card text-dark mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-fibro/monopente+auvent.php"><img src="../assets/img/image-site/cat-monopente-auvent.gif" class="img-fluid" alt="Monopente + Auvent"></src>
                </a>
            </div>
            <div class="card text-white mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-fibro/monopente.php"><img src="../assets/img/image-site/cat-monopente.gif" class="img-fluid" alt="Monopente"></src>
                </a>
...
<div class="m-information col-10 mb-5 mx-auto">
        <div class="row">
            <div class="card text-dark mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-fibro/bipente.php"><img src="../assets/img/image-site/cat-bipente.gif" class="img-fluid" alt="Bipente"></src>
                </a>
            </div>
            <div class="card text-white mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                <div class="card-body" style="text-align: center;">
                ...
                <a href="couv-fibro/auvent.php"><img src="../assets/img/image-site/cat-auvent.gif" class="img-fluid" alt="Auvent"></src>
                </a>
...
<div class="m-information col-10 mb-5 mx-auto">
        <div class="row">
            <div class="card text-dark mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-fibro/appentis.php"><img src="../assets/img/image-site/cat-appentis.gif" class="img-fluid" alt="Appentis"></src>
                </a>
            </div>
