...
<div class="m-information col-10 mb-5 mx-auto">
        <div class="row">
            ...
            <div class="card text-white mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-tole/monopente.php"><img src="../assets/img/cat-monopente.gif" class="img-fluid" alt="Responsive image"></src>
                </a>
...
<div class="m-information col-10 mb-5 mx-auto">
        <div class="row">
            <div class="card text-dark mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-tole/bipente.php"><img src="../assets/img/cat-bipente.gif" class="img-fluid" alt="Responsive image"></src>
                </a>
            </div>
            <div class="card text-white mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                <div class="card-body" style="text-align: center;">
                ...
                <a href="couv-tole/auvent.php"><img src="../assets/img/cat-auvent.gif" class="img-fluid" alt="Responsive image"></src>
                </a>
...
<div class="m-information col-10 mb-5 mx-auto">
        <div class="row">
            <div class="card text-dark mt-5 mb-3 mx-auto col-10 col-md-0 c-l border-0" style="max-width: 20rem;">
                ...
                <a href="couv-tole/appentis.php"><img src="../assets/img/cat-appentis.gif" class="img-fluid" alt="Responsive image"></src>
                </a>
            </div>
